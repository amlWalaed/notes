                                ...
                                <div class="flex gap-x-3">
                                    <?php if ($_SESSION['user'] ?? false) : ?>
                                        ...
                                        <form method="POST" action="/login">
                                            ...
                                            <button class="<?= urlIs('/registration') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white ' ?> rounded-md px-3 py-2 text-sm font-medium">log out</button>
                                        </form>
                                    <?php else : ?>
                                        <a href="/registration" class="<?= urlIs('/registration') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white ' ?> rounded-md px-3 py-2 text-sm font-medium">regster</a>
